...
class Orders extends RestController {
    ...
    public function cart_get()
    {
       ...
       if($user_id != null)
       {
            ...
            'total_harga'       => $this->cart_model->getTotalHarga($user_id),
    ...
    public function index_post()
    {
        ...
        if($user_id != null && $kurir != null && $ongkos_kirim != null && $produk != null && $alamat != null && $total != null)
        {
            $this->response([
                'success'   => TRUE,
                'data' => $this->order_model->transactions($user_id, $kurir, $ongkos_kirim, $produk, $alamat, $total),
                'message'   => ""
            ], 200);
        }else
        {
