...
<div class="row col-md-12">
  <div class="col-md-7">
    <h3 class="card-title bg-warning p-2 rounded">
      <i class="fas fa-user mr-2"></i><b class="text-dark">MINOR COFFEE</b> | My Account
    </h3>
  </div>
  <div class="col-md-3">
  ...
  <div class="row col-md-12 mb-5">
    <div class="row col-md-3">
        <div class="list-group col-md-12 mt-3">
            ...
            <?php echo anchor('user_dashboard/daftar','<div class="list-group-item text-dark"><i class="fas fa-book mr-2"></i>Riwayat Pembelian</div>')?><br>
            <a href="" data-toggle="modal" data-target="#logoutModal" class="list-group-item text-dark bg-danger float-sm-right"><i class="fas fa-key mr-2"></i>Logout</a>
          </div>
    </div>
