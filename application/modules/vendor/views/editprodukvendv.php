            ...
            <section class="content">
                ...
                <div class="card" style="width: 200%;">
                    ...
                    <?php foreach ($edit as $p) : ?>
                        <form class="user" method="POST" action="<?= base_url('vendor/update'); ?>" enctype="multipart/form-data">
                            <div class="form-group row">
                                <label class="col-sm-5 col-form-label">ID Vendor</label>
                                <div class="col-sm-2">
                                    <input type="text" name="vend_id" class="form-control form-control-user" placeholder="Vendor" value="<?= $p['vend_id']; ?>" readonly>
                            ...
                            <div class="form-group row mb-5">
                                <label class="col-sm-5 col-form-label">Foto Produk</label>
                                <div class="col-sm-7">
                            ...
                            <div class="form-group row">
                                <div class="offset-sm-5 col-sm-10">
                                    ...
                                    <a href="<?php echo base_url('vendor/jualproduk'); ?>" class="btn bg-danger btn-md">Batal</a>
                                </div>
                            </div>
                        </form>
                    <?php endforeach; ?>
                    </div>
                    <div class="card-footer text-right">Minor Coffee © 5050 - by Nuno Akbar</div>
                </div>
            </section>
        </div>
    </div>
